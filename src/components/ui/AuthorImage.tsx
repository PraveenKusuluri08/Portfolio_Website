...
const AuthorImage = ({ src, alt }: Props) => {
  return (
    <motion.div 
      className="relative w-64 h-64 border-2 border-accent border-double rounded-md group sm:w-auto sm:h-auto"
    ...
    >
      <div className="relative overflow-hidden rounded-md">
        <Image
          ...
          width={300}
          height={300}
          className="rounded shadow-2xl transition-transform duration-300 group-hover:scale-105"
        />
